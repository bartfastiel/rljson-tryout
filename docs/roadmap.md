...
| `GET /api/species/:hash/image`                                   | PNG bytes of that species version, `Content-Type: image/png`, `Cache-Control: public, max-age=31536000, immutable` (the hash names the version, the version names the image by content), `404` for a hash no species version has (slice B12)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
